...
while True:
    ...
    if result:
        ...
        if outputs.multi_face_landmarks:
            ...
            if ratio_lips < 1.8:
                message = 'Drowsy Warning: Please focus on road'
            ...
            font_thickness = 2
            x, y = 30, 30
            img_text = cv.putText(image, str(frame_count), (30,30), font, font_size, font_color, font_thickness, cv.LINE_AA)
            img_text = cv.putText(image, str(warnings_given), (100, 30), font, font_size, font_color, font_thickness, cv.LINE_AA)
            img_text = cv.putText(image, str(round(ratio, 3)), (30, 60), font, font_size, font_color, font_thickness, cv.LINE_AA)
            img_text = cv.putText(image, str(round(ratio_lips, 3)), (30, 90), font, font_size, font_color, font_thickness, cv.LINE_AA)
